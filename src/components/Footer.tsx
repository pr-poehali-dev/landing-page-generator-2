    ...
    <footer className="bg-gradient-to-br from-primary/10 via-background to-accent/10 border-t-2 border-primary/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          {/* Контакты */}
          <div>
            <h4 className="font-heading font-bold mb-4 text-lg text-foreground">Контакты</h4>
          ...
          {/* Режим работы */}
          <div>
            <h4 className="font-heading font-bold mb-4 text-lg text-foreground">Режим работы</h4>
          ...
          {/* Соцсети */}
          <div>
            <h4 className="font-heading font-bold mb-4 text-lg text-foreground">Мы в соцсетях</h4>
