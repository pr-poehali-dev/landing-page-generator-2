  ...
  const renderPricingCard = (plan: typeof allPlans[0], idx: number) => (
    ...
    >
      ...
      <CardContent className="space-y-6 flex-1 flex flex-col">
        ...
        <Button 
          className={`w-full mt-4 ${plan.popular ? 'bg-gradient-to-r from-[#00F0FF] via-[#43E3FF] to-[#FF4FD8] text-[#050816] font-semibold hover:shadow-[0_0_30px_rgba(0,240,255,0.6),0_0_50px_rgba(255,79,216,0.4)] animate-[softPulse_3s_ease-in-out_infinite] transition-all duration-300' : ''}`}
          size="lg"
