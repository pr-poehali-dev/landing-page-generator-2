  ...
  const allPlans = [
    {
      ...
      features: [
        ...
        "Премиум корм 2 раза в день",
        "Ежедневная уборка",
        "Осмотр ветеринара",
        "Фотоотчет в WhatsApp",
        "Доступ к игровой зоне 1 час"
      ],
      icon: "Home"
    },
    {
      ...
      features: [
        "Номер 5 кв.м с игрушками",
        "Видеонаблюдение 24/7",
        "Доступ к игровой 2+ часа",
        "Базовый груминг (расчесывание)",
        "Социализация с другими котиками",
        "Ежедневные видеоотчеты",
        "Бесплатная доставка в обе стороны"
      ],
      icon: "Star"
    },
    {
      ...
      features: [
        "Номер 8 кв.м с панорамным окном",
        "Видеозвонки по запросу",
        "Неограниченный доступ к игровой",
        "Полный спа-комплекс (груминг, массаж)",
        "Персональный кейс-менеджер",
        "Меню на выбор (3 вида корма)",
        "Индивидуальные прогулки",
        "VIP доставка с переноской"
      ],
      icon: "Crown"
    }
  ];
